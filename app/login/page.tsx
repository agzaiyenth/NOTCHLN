          ...
          <CardContent className="space-y-6">
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-govdocs-blue hover:text-blue-700">
                  Forgot Password?
                </Link>
              </div>
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link href="/signup" className="text-govdocs-blue hover:text-blue-700 font-medium">
                Sign up
              </Link>
            </div>
          </CardContent>
