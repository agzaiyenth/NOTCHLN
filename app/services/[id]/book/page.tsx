    ...
    (async function () {
      try {
        ...
        window.addEventListener("cal.com:bookingSuccessful", (e: any) => {
          ...
          router.push(
            `/services/${serviceId}/book/success?appointmentId=${e.detail.bookingId}`
          );
        });
      } catch (error) {
                  ...
                  <Cal
                    ...
                    config={{
                      ...
                      metadata: {
                        serviceId: serviceId,
                        namespace:
                          process.env.NEXT_PUBLIC_CAL_NAMESPACE || "govdocs",
                      },
                    }}
                  />
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-govdocs-blue">
                      Lkr 2,500
                    </span>
                  </div>
                </div>
                ...
                <div className="border-t pt-4">
                  <div className="text-sm text-gray-600">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      ...
                      <li>
                        Previous {getServiceName(serviceId)} (if applicable)
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
                  <strong>Note:</strong> You will be redirected to secure
                  payment processing after confirming your booking details.
                </div>
              </CardContent>
            </Card>
          </div>
