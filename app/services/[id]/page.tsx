...
const serviceDetails = {
  "nic-passport": {
    ...
    description:
      "Complete identity document services including new applications, renewals, and replacements",
    icon: FileText,
    ...
    faqs: [
      {
        ...
        answer:
          "Typically 7-10 working days after your appointment and document verification.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, you'll receive an application ID to track your progress through our dashboard.",
      },
    ],
  },
};
      ...
      <header className="bg-white border-b px-4 py-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-4">
            <Link
              href="/services"
              className="text-govdocs-blue hover:text-blue-700"
            >
                  ...
                  {service.services.map((subService, index) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="font-bold text-govdocs-blue">
                          {subService.fee}
                        </div>
                        <Button
                          size="sm"
                          className="mt-2 bg-govdocs-blue hover:bg-blue-700"
                          asChild
                        >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-govdocs-blue">
                      {service.fee}
                    </div>
                    ...
                    <div className="text-xs text-gray-500 mt-2">
                      Final fee depends on specific service selected
                    </div>
                  </div>
                </CardContent>
              </Card>
